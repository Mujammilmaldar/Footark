...
<!-- 
                        ...
                        <div class="doctor-stats">
                            <div class="stat-card">
                                ...
                                <div class="stat-description">Minimally invasive keyhole surgery for ankle joint
                                    problems.</div>
                            </div>
                            <div class="stat-card">
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="doctor-image">
                        <img src="assets/images/home-about/Dr.AbhishekKini-Homepage.webp" alt="Dr. Abhishek Kini"
                            class="img-fluid">
                    </div>
                </div>
            </div>
                        ...
                        <div class="biography-accordion">
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <h3><a href="#core-expertise">Core Expertise <i class="fas fa-plus"></i></a></h3>
                                </div>
                            </div>

                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <h3><a href="#fellowships">Key Fellowships & Advanced Training <i
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <h3><a href="#research">Research & Publications <i class="fas fa-plus"></i></a></h3>
                                </div>
                            </div>

                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <h3><a href="#academic">Academic & Teaching Roles <i class="fas fa-plus"></i></a>
                                    </h3>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <h3><a href="#memberships">Professional Memberships <i class="fas fa-plus"></i></a>
                                    </h3>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <h3><a href="#hospitals">Hospital Affiliations <i class="fas fa-plus"></i></a></h3>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="biography-details-section">
        <div class="container">
            ...
            <div class="details-section">
                <div id="core-expertise" style="scroll-margin-top: 100px;">
            ...
            <!-- Fellowships Section -->
            <div class="details-section">
                <div id="fellowships" style="scroll-margin-top: 100px;">
            ...
            <!-- Academic Section -->
            <div class="details-section">
                <div id="academic" style="scroll-margin-top: 100px;">
            ...
            <!-- Memberships Section -->
            <div class="details-section">
                <div id="memberships" style="scroll-margin-top: 100px;">
            ...
            <div class="details-section">
                <div id="hospitals" style="scroll-margin-top: 100px;">
