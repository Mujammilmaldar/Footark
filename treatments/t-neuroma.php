            ...
            <div class="content-layout">
                ...
                <div class="sidebar">
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            <nav class="toc-nav">
                                <ul class="toc-list">
                                    <li><a href="#understanding" class="toc-link">What is Neuroma Excision</a></li>
                                    <li><a href="#preparation" class="toc-link">How to Prepare</a></li>
                                    <li><a href="#surgery-process" class="toc-link">What Happens During Surgery</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="widget widget-dr-kini mobile-hidden">
                        <img src="../assets/images/home-about/Dr.AbhishekKini-Homepage.webp" alt="Neuroma Excision">
                ...
                <div class="main-content">
                    <div class="content-section" id="understanding">
                        <h2>What is neuroma excision?</h2>
                    ...
                    <div class="content-section" id="surgery-process">
