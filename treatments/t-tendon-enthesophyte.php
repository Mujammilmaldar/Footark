            ...
            <div class="hero-container">
                <div class="inner-container">
                    <div class="hero-breadcrumb" style="margin-bottom: 15px; font-size: 14px; color: #ffffff;">
                        ...
                        <span style="color: #ffffff;">Achilles Tendon Enthesophyte Debridement</span>
                    </div>
                    <div class="hero-content">
                        <h1>Achilles Tendon Enthesophyte Debridement</h1>
                        
                        <!-- Mobile Image - Shows after heading on mobile only -->
                        <div class="mobile-hero-image desktop-hidden">
                            <img src="images/Achillestendonenthesophytedebridement1.jpg" alt="Achilles Tendon Debridement">
                        </div>
                        
                        <p>Specialized Achilles tendon enthesophyte debridement surgery for heel spur removal and tendon repair. Our advanced techniques address insertional Achilles problems and restore proper function.</p>
            ...
            <div class="content-layout">
                ...
                <div class="sidebar">
                    ...
                    <div class="widget widget-dr-kini mobile-hidden">
                        <img src="../assets/images/home-about/Dr.AbhishekKini-Homepage.webp" alt="Achilles Tendon Debridement">
                ...
                <div class="main-content">
                    <div class="content-section" id="understanding">
                        <h2>What is Achilles tendon enthesophyte debridement?</h2>
